...
hi StatusLine term=NONE cterm=NONE ctermfg=black ctermbg=fg gui=NONE guifg=bg guibg=fg
hi StatusLineNC term=NONE cterm=NONE ctermfg=black ctermbg=fg gui=NONE guifg=bg guibg=fg
